            ...
            messages: [
                {
                    role: "system",
                    content:
                    "You are to take in a string representing one food item and return a Javascript array." +
                    "The array MUST be structured in this way [[item name, best boiling time]]" +
                    ...
                    "Ensure that best boiling time is in seconds of no less than 5 and no more than 300 and correct for the food item.",
                },
                {
                    role: "user",
                    content: itemName,
